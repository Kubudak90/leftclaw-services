        ...
        <div className="relative w-full rounded-xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start p-10 md:p-16">
            <div className="max-w-lg">
              ...
              <Link href="/pfp" className="btn btn-primary">
                🎨 Generate your PFP →
              </Link>
            </div>
          </div>
        ...
        <div className="relative w-full rounded-xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-end p-10 md:p-16">
            <div className="max-w-lg text-right">
              ...
              <Link href="/post?type=7" className="btn btn-primary">
                🛡️ Order an Audit →
              </Link>
            </div>
          </div>
        ...
        <div className="relative w-full rounded-xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start p-10 md:p-16">
            <div className="max-w-lg">
              ...
              <Link href="/post?type=6" className="btn btn-primary">
                🔍 Order a QA Report →
              </Link>
            </div>
          </div>
        ...
        <div className="relative w-full rounded-xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-end p-10 md:p-16">
            <div className="max-w-lg text-right">
              ...
              <Link href="/post?type=custom" className="btn btn-primary">
                🔬 Commission Research →
              </Link>
            </div>
          </div>
        ...
        <div className="relative w-full rounded-xl overflow-hidden mb-8">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-start p-10 md:p-16">
            <div className="max-w-lg">
              ...
              <Link href="/post?type=9" className="btn btn-primary">
